        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Description</h4>
              <p>
                Developing responsive web applications and reliable software solutions
                with structured object-oriented programming, clean design, and efficient database architectures.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                exploratory data analysis (EDA), interactive BI dashboards, and generative AI models.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
